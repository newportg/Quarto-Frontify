...
```{.plantuml pumlfile="AzureFunction"}
```
...
```{.plantuml pumlfile="GetTemplates"}
```
...
```{.plantuml pumlfile="GetTemplatesRes"}
```
...
```{.plantuml pumlfile="CompleteBrochure"}
```
...
```{.plantuml pumlfile="GetBySourceAppRes"}
```
...
```{.plantuml pumlfile="GetByUserCountRes"}
```

  *   Detail response

```{.plantuml pumlfile="GetByUserDetailRes"}
```
...
```{.plantuml pumlfile="GetByImpersonatingCountRes"}
```

  *   Detail response

```{.plantuml pumlfile="GetByImpersonatingDetailRes"}
```
...
```{.plantuml pumlfile="GetByHostCountRes"}
```

    *   Detail response

```{.plantuml pumlfile="GetByHostDetailRes"}
```
